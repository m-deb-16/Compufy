...
const Footer = () => {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setCurrentTime(new Date().toLocaleString("en-IN").split(" ")[1]);
    }, 1000);
          ...
          <div className="container-fluid overflow-hidden">
            <div className="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
              ...
              <div className="col-xs-12 col-xl-6 order-2 order-xl-1">
                <ul className="nav justify-content-center">
                  <li className="nav-item">
                    <Link
                      className="nav-link foot_link link-secondary px-2 px-md-3"
                      to="/"
                    >
                      Home
                    </Link>
              ...
              <div className="col-xs-12 col-sm-6 col-xl-3 order-1 order-xl-2">
                <div className="social-media-wrapper social_media_pad">
...
//     <>
//       <footer>
//         <div classNameName="row-foot">
//           <div classNameName="col4 col4_align">
//             <h3>Quick Links</h3>
//             <ul>
//               <li>
//                 <Link to="/">Home</Link>
